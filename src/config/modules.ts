  ...
  hr: {
    ...
    submodules: [
      ...
      },
      {
        id: "beneficiaries",
        label: "Beneficiarios",
        path: "/app/hr/beneficiaries",
        icon: "contact",
        rolesAllowed: [1, 2, 3],
      },
      {
        id: "settlement",
        label: "Liquidacion final",
        path: "/app/hr/settlement",
        icon: "file-text",
        rolesAllowed: [1, 2, 3],
      },
      {
  ...
  fnz: {
    ...
    submodules: [
      ...
      },
      {
        id: "cash-flow",
        label: "Flujo de Caja",
        path: "/app/fnz/cash-flow",
        icon: "trending-up",
      },
      {
        id: "profitability",
        label: "Rentabilidad",
        path: "/app/fnz/profitability",
        icon: "trending-up",
      },
      {
        id: "loyalty-points",
